...
const run = async () => {
  try {
    ...
    const androidUrl = 'https://play.google.com/store/apps/details?id=com.confirmdwallet'
    const appleUrl = 'https://apps.apple.com/us/app/confirmd-wallet/id1587380443'
